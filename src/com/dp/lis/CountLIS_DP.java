...
public class CountLIS_DP {
	...
	/*
	 * LIS(i) = 1 if i == 1 LIS(i) = max(LIS(j)) + 1 if 0 < j < i and a[i] < a[j]
	 * Time Complexity: O(n ^ 2) --- Loop + recusion stack Space: O(n)
	 * 
	 */
	...
	/**
	 * This is bottom-up DP implementation but it uses same concept as used in TD
	 * approach. It starts in reverse order.
	 *
	 */
